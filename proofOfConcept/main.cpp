...
int b1;
int b2;
int data[columns] = {0, 0, 0, 0, 48, 56, 440, 492, 6140, 8184, 7936, 768, 768, 1792, 768, 256, 0, 0, 0, 0}; //dino
//String converted = "";
...
void setup() {
    Serial.begin(4800);
    address += 16; //For an unknown reason, the MSB part is always equal to 0x31 (1) The LSB part is equal to the address defined by the rotary switch located inside the display + 1.
}
